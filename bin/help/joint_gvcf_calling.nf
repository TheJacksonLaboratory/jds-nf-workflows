...
--csv_input | /<FILE_PATH> | CSV delimited sample sheet that controls how samples are processed. The required input header is: sampleID,outputID,gvcf. See the repository wiki (https://github.com/TheJacksonLaboratory/jds-nf-workflows/wiki) for additional information. 
...
--interval_count | 50 | The number of genomic intervals to scatter the GVCF merge and genotyping over.
'''
}