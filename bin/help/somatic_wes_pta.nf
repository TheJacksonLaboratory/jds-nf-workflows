...
--trim_poly_g | false | For Illumina NextSeq/NovaSeq data, polyG can happen in read tails since G means no signal in the Illumina two-color systems. fastp can detect the polyG in read tails and trim them. This option is disabled by default. If your data is from NextSeq or NovaSeq, please enable this option to get better result.
...
--ref_fa | '/projects/omics_share/human/GRCh38/genome/sequence/gatk/Homo_sapiens_assembly38.fasta' | The reference fasta to be used throughout the process for alignment as well as any downstream analysis. 
...
--sequenza_gc | '/projects/compsci/omics_share/human/GRCh38/supporting_files/sequenza/Homo_sapiens_assembly38_gc50.wig.gz' | GC content windows used by Sequenza in CNV analysis. Generated from `sequenza-utils gc_wiggle`
--ensembl_database | '/projects/compsci/omics_share/human/GRCh38/transcriptome/annotation/ensembl/v110/GRCm39_ensemblv110_annotDB.txt' | Ensembl gene annotation file, used to annotate CNV results from Sequenza. 

--dbSNP | '/projects/omics_share/human/GRCh38/genome/annotation/snps_indels/dbsnp_151.vcf.gz' | The dbSNP database contains known single nucleotide polymorphisms, and is used in the annotation of known variants. Points to human dbSNP when --gen_org human. 

--gen_ver | 'hg38' | snpEff genome version. Sets to 'hg38' when --gen_org human 

--snpEff_config | Human: '/projects/omics_share/human/GRCh38/genome/indices/snpEff_5_1/snpEff.config' | The configuration file used while running snpEff, points to human snpEff file when --gen_org human. 
