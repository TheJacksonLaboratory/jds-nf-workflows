...
--ref_gff | null | Used in cases where no GTF is available. When specifiying GFF, set `--gtf ''` in the nextflow command. The workflow first converts to GTF using AGAT_GFFTOGTF before continuing.
