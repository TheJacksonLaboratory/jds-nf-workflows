...
include {SAMTOOLS_SORT as SAMTOOLS_SORT_PRIMERCLIP;
         SAMTOOLS_SORT as SAMTOOLS_SORT_CALLING} from "../modules/samtools/samtools_sort"
include {PRIMERCLIP} from "../modules/primerclip/primerclip"
...
include {GATK_HAPLOTYPECALLER} from "../modules/gatk/gatk_haplotypecaller"
include {SNPSIFT_ANNOTATE} from "../modules/snpeff_snpsift/snpsift_annotate"
include {GENERATE_FINGERPRINT_REPORT} from "../modules/python/python_generate_fingerprint_report"
include {MULTIQC} from "../modules/multiqc/multiqc"

workflow AMPLICON_FINGERPRINT {
  ...
  */
  ...
  ch_multiqc_files = ch_multiqc_files.mix(PRIMERCLIP.out.log.collect{ it -> it[1]}.ifEmpty([]))
