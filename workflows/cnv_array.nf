...
// Import modules
include {help} from "../bin/help/cnv_array.nf"
include {param_log} from "../bin/log/cnv_array.nf"
include {final_run_report} from "../bin/shared/final_run_report.nf"
include {extract_csv} from "../bin/shared/extract_cnv_array_csv.nf"
include {IAAP_CLI} from "../modules/illumina/iaap_cli.nf"
include {BCFTOOLS_GTC2VCF} from "../modules/bcftools/bcftools_gtct2vcf.nf"
include {BCFTOOLS_QUERY_ASCAT} from "../modules/bcftools/bcftools_query_ascat.nf"
include {ASCAT} from "../modules/ascat/ascat_run.nf"
include {ASCAT_ANNOTATION} from "../modules/ascat/ascat_annotation.nf"
