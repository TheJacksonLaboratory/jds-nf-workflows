...
// import modules
include {help} from "../bin/help/amplicon.nf"
include {param_log} from "../bin/log/amplicon.nf"
...
include {ABRA2} from "../modules/abra2/abra2"

include {GATK_BASERECALIBRATOR;
         GATK_BASERECALIBRATOR as GATK_BASERECALIBRATOR_ABRA2} from "../modules/gatk/gatk_baserecalibrator"
include {GATK_APPLYBQSR;
         GATK_APPLYBQSR as GATK_APPLYBQSR_ABRA2} from "../modules/gatk/gatk_applybqsr"

include {TARGET_COVERAGE_METRICS} from "../modules/bedtools/bedtools_amplicon_metrics"
include {PICARD_COLLECTTARGETPCRMETRICS} from "../modules/picard/picard_collecttargetpcrmetrics"

include {GATK_HAPLOTYPECALLER} from "../modules/gatk/gatk_haplotypecaller_amplicon"
...
include {GATK_VARIANTFILTRATION as GATK_VARIANTFILTRATION_FREEBAYES} from "../modules/gatk/gatk_variantfiltration_freebayes"

include {BCFTOOLS_NORM as BCFTOOLS_NORM_HAPLOTYPECALLER;
         BCFTOOLS_NORM as BCFTOOLS_NORM_FREEBAYES} from "../modules/bcftools/bcftools_norm"

include {GATK_MERGEVCF} from "../modules/gatk/gatk_mergevcf"

include {ADD_ALT_AF as ADD_ALT_AF_HAPLOTYPECALLER} from "../modules/python/python_add_AF_haplotypecaller"
include {ADD_ALT_AF as ADD_ALT_AF_FREEBAYES} from "../modules/python/python_add_AF_freebayes"

include {BCFTOOLS_MERGECALLERS} from "../modules/bcftools/bcftools_merge_amplicon"
...
workflow AMPLICON_GENERIC  {
  ...
  */
  ...
  ch_multiqc_files = ch_multiqc_files.mix(PICARD_COLLECTTARGETPCRMETRICS.out.txt.collect{ it -> it[1]}.ifEmpty([]))
  ch_multiqc_files = ch_multiqc_files.mix(TARGET_COVERAGE_METRICS.out.qc_metrics.collect{ it -> it[1]}.ifEmpty([]))
