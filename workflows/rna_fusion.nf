...
// import modules
include {help} from "../bin/help/rna_fusion.nf"
include {param_log} from "../bin/log/rna_fusion.nf"
...
include {GUNZIP} from "../modules/utility_modules/gunzip_reads"
...
include {STAR_ALIGN as STAR_ARRIBA;
         ...
         STAR_ALIGN as STAR_STARFUSION} from "../modules/star/star_align"
include {SAMTOOLS_SORT as SORT_ARRIBA;
         SAMTOOLS_SORT as SORT_SQUID} from "../modules/samtools/samtools_sort"
include {SAMTOOLS_INDEX as INDEX_ARRIBA} from "../modules/samtools/samtools_index"
include {ARRIBA} from "../modules/arriba/arriba"
include {FUSIONCATCHER} from "../modules/fusioncatcher/fusioncatcher"
include {JAFFA} from "../modules/jaffa/jaffa"
include {KALLISTO_QUANT} from "../modules/kallisto/kallisto_quant"
include {KALLISTO_INSERT_SIZE} from "../modules/kallisto/kallisto_insert_size"
include {PIZZLY} from "../modules/pizzly/pizzly"
include {SQUID} from "../modules/squid/squid_call"
include {SQUID_ANNOTATE} from "../modules/squid/squid_annotate"
...
workflow RNA_FUSION {
    ...
    ch_multiqc_files = ch_multiqc_files.mix(FUSION_REPORT.out.summary_fusions_mq.collect{ it -> it[1]}.ifEmpty([]))
