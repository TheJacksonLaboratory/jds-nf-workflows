process DEEPTOOLS_PLOTFINGERPRINT {
    ...
    publishDir path: { "${params.pubdir}/${'immuno_precip_samples/' + ip + '_vs_' + control + '/deeptools'}" }, pattern: "*.pdf", mode: 'copy'
    publishDir path: { "${params.pubdir}/${'immuno_precip_samples/' + ip + '_vs_' + control + '/deeptools'}" }, pattern: "*.raw.txt", mode: 'copy'
    publishDir path: { "${params.pubdir}/${'immuno_precip_samples/' + ip + '_vs_' + control + '/deeptools'}" }, pattern: "*.qcmetrics.txt", mode: 'copy'
