process GATK_FILTERMUECTCALLS {
    ...
    publishDir path: { "${params.pubdir}/${sampleID + '/mt_callers'}" }, pattern: "*exclusionFiltered.final.vcf*", mode:'copy'
    publishDir path: { "${params.pubdir}/${sampleID + '/mt_callers/stats'}" }, pattern: "*.filteringStats.tsv", mode:'copy'
