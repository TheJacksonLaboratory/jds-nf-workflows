process GENERATE_SIMULATED_WES_DATA {
    ...
    publishDir path: { "${params.pubdir}/reads/individual_chr" }, pattern: '*fq.gz', mode:'copy'  
    publishDir path: { "${params.pubdir}/gold_truth_vcf/individual_chr" }, pattern: '*golden.vcf', mode:'copy'  
