process SVABA {
    ...
    publishDir path: { "${params.pubdir}/${sampleID + '/callers'}" }, pattern: "*germline*.vcf.gz", mode:'copy'
    publishDir path: { "${params.pubdir}/${sampleID + '/callers'}" }, pattern: "*somatic*.vcf.gz", mode:'copy'
